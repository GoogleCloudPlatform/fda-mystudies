...
## What’s changed?
The overall goals, compliance principles and functionality of this FDA MyStudies release is similar to previous releases. Notable changes from version [`2019.10`](https://github.com/PopMedNet-Team/FDA-My-Studies-Mobile-Application-System/tree/2019.10) of FDA MyStudies include:
...
*   Added the [`Participant manager`](/participant-manager/) graphical user interface and [`Participant datastore`](/participant-datastore/) API to manage participant enrollment
...
*   Migrated open-source dependencies to alternatives with permissive licenses 
...
* Created [deployment templates](/deployment/) that support security best practices, such as:
  * Automation of secret generation and handling
    ...
    * Configured secret values to be transmitted automatically with the private Kubernetes cluster
  ...
  * Implementation of [external access limitations](https://cloud.google.com/docs/enterprise/best-practices-for-enterprise-organizations#limit-access)
    * Configured databases and VMs to be isolated from the internet with only internal IP addresses - access to Google APIs and services utilize [Private Google Access](https://cloud.google.com/vpc/docs/configure-private-google-access)
  ...
  * [Delegation of responsibility](https://cloud.google.com/docs/enterprise/best-practices-for-enterprise-organizations#groups-and-service-accounts) with groups and service accounts
