    ...
    <div>
      <form:form id="passwordResetForm" data-toggle="validator" role="form" action="addPassword.do" method="post"
        ...
        <c:if test="${isValidToken}">
          <div>
          <p class="white__text">Please set up your new password using this form. You would be required to enter the
            access code provided to you over email for the same.</p>
          <div class="mb-lg form-group">
            <input autofocus="autofocus" type="text" class="input-field wow_input" id="" tabindex="1" name="accessCode"
                   maxlength="6" placeholder="Access Code" data-error="Access Code is invalid" required
                   autocomplete="off"/>
          ...
          <div class="mb-lg form-group">
            <input type="password" class="input-field wow_input" id="cfnPassword" tabindex="3" name="" maxlength="64"
                   data-match="#password" data-match-error="Whoops, these don't match" placeholder="Confirm password"
        ...
        <c:if test="${not isValidToken}"><p class="passwordExp"><i class="fa fa-exclamation-circle"
                                                                   aria-hidden="true"></i>The Password Reset Link is
