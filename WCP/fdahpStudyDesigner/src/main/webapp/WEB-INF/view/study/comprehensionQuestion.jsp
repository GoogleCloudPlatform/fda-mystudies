  ...
  <form:form
    ...
    <div class="right-content-head">
      <div class="text-right">
        <div class="black-md-f dis-line pull-left line34"><span class="pr-sm cur-pointer"
    ...
    <div class="right-content-body pt-none pb-none">
      ...
      <div>
        <div class="gray-xs-f mb-xs mt-md">Question Text (1 to 300 characters)<span
          ...
          <c:if test="${fn:length(comprehensionQuestionBo.responseList) eq 0}">
            <div class="col-md-12 p-none">
              <div class='col-md-6 pl-none'>
                <div class="gray-xs-f mb-xs">Answer Options (1 to 150 characters)<span
                    class="requiredStar">*</span></div>
              </div>
              <div class='col-md-3'>
                <div class="gray-xs-f mb-xs">Correct Answer <span class="requiredStar">*</span>
                </div>
              </div>
      ...
      <div>
        <div class="gray-xs-f mb-sm">Choose structure of the correct answer <span
