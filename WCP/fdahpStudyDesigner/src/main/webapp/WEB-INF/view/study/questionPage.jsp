      ...
      <div id="rla" class="tab-pane fade mt-xlg">
        ...
        <div id="responseTypeDivId">
          ...
          <div id="Scale" style="display: none">
            ...
            <div class="row mb-xs">
              ...
              <div class="col-md-6 ">
                <div class="col-md-9 col-lg-9 p-none">
                  <div class="gray-xs-f mb-xs">Number of Step <span
        ...
        <div id="ContinuousScale" style="display: none">
          ...
          <div class="row mt-md mb-xs">
            <div class="col-md-6 pl-none">
              <div class="col-md-9 col-lg-9 p-none">
                <div class="gray-xs-f mb-xs">Minimum Value <span class="requiredStar">*</span> <span
                    class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                    title="Enter an integer number in the range (Min, 10000)."></span></div>
                <div class="form-group">
            ...
            <div class="col-md-6">
              <div class="col-md-9 col-lg-9 p-none">
                <div class="gray-xs-f mb-xs">Maximum Value <span class="requiredStar">*</span> <span
                    class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                    title="Enter an integer number in the range (Min+1, 10000)."></span></div>
                <div class="form-group">
                  <input type="text" class="form-control ContinuousScaleRequired"
          ...
          <div class="row mb-xs">
            <div class="col-md-6  pl-none">
              <div class="col-md-9 col-lg-9 p-none">
                <div class="gray-xs-f mb-xs">Default value (slider position) <span
                    class="requiredStar">*</span>
                  <span class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                        title="Enter an integer between the minimum and maximum."></span></div>
                <div class="form-group">
                  <input type="text" class="form-control ContinuousScaleRequired"
            ...
            <div class="col-md-6">
              <div class="col-md-6 col-lg-4 p-none">
                <div class="gray-xs-f mb-xs">Max Fraction Digits <span class="requiredStar">*</span>
                  <span class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
        ...
        <div id="Text" style="display: none">
          ...
          <div class="row mt-lg">
            <div class="col-md-6 pl-none">
              <div class="col-md-12 col-lg-12 p-none">
                <div class="gray-xs-f mb-xs">Placeholder (1 to 40 characters) <span
                    class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                    title="Enter an input hint to the user"></span></div>
                <div class="form-group">
        ...
        <div id="TextScale" style="display: none;">
          ...
          <div class="row">
            <div class="col-md-3 pl-none">
              <div class="gray-xs-f mb-xs">Display Text (1 to 15 characters)<span
                  class="requiredStar">*</span></div>
            </div>
            <div class="col-md-4 pl-none">
              <div class="gray-xs-f mb-xs">Value (1 to 50 characters)<span
                ...
                <c:forEach items="${questionsBo.questionResponseSubTypeList}"
                  ...
                  <div class="text-scale row" id="${subtype.index}">
                    ...
                    <div class="col-md-2 pl-none mt__8">
                      <c:choose>
                        <c:when
                            test="${fn:length(questionsBo.questionResponseSubTypeList) eq 8 }"><span
        ...
        <div id="TextChoice" style="display: none;">
          ...
          <div class="clearfix"></div>
          <div class="gray-choice-f mb-xs">Text Choices<span class="ml-xs sprites_v3 filled-tooltip"
                                                             data-toggle="tooltip"
            ...
            <c:choose>
              ...
              <c:otherwise>
                ...
                <div class="text-choice mt-xlg" id="0">
                  ...
                  <div class="col-md-12 p-none display__flex__center">
                    <div class="col-md-10 pl-none">
                      <div class="gray-xs-f mb-xs">Description(1 to 150 characters) <span
                          class="requiredStar">*</span></div>
                      <div class="form-group">
                                                <textarea class="form-control"
        ...
        <div id="ImageChoice" style="display: none;">
          ...
          <div class="mt-sm row">
            <div>
              ...
              <div class="col-md-2 pl-none col-smthumb-2">
                <div class="gray-xs-f mb-xs">Selected Image <span class="requiredStar">*</span><span
                    class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip" data-html="true"
                    title="JPEG / PNG <br> Recommended Size: <br>Min: 90x90 Pixels<br>Max: 120x120 Pixels<br>(Maintain aspect ratio for the selected size of the image)"></span>
                </div>
              </div>
