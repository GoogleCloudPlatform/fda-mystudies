  ...
  <form:form action="/studybuilder/adminStudies/saveOrUpdateInstructionStep.do?_S=${param._S}"
    ...
    <div class="right-content-head">
      <div class="text-right">
        <div class="black-md-f text-uppercase dis-line pull-left line34"><span
    ...
    <div class="right-content-body">
      ...
      <div class="col-md-6 pl-none">
        <div class="gray-xs-f mb-xs">Step Short Title or Key (15 characters max)<span
      ...
      <div class="gray-xs-f mb-xs">Title (250 characters max)<span class="requiredStar">*</span>
      </div>
      <div class="form-group">
      ...
      <div class="gray-xs-f mb-xs">Instruction Text (1 to 500 characters)<span class="requiredStar">*</span>
      </div>
      <div class="form-group">
      ...
      <c:if test="${questionnaireBo.branching}">
        <div class="col-md-4 col-lg-3 p-none">
          <div class="gray-xs-f mb-xs">Default Destination Step <span class="requiredStar">*</span>
            <span
                class="ml-xs sprites_v3 filled-tooltip"></span></div>
          <div class="form-group">
