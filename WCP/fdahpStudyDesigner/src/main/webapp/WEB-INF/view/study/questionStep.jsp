        ...
        <div id="responseTypeDivId">
          ...
          <div id="Scale" style="display: none">
            ...
            <div class="row mb-xs">
              ...
              <div class="col-md-6">
                <div class="col-md-9 col-lg-9 p-none">
                  <div class="gray-xs-f mb-xs">Number of Steps <span class="requiredStar">*</span>
                    <span class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
            ...
            <div class="row mb-xs">
              <div class="col-md-6  pl-none">
                <div class="col-md-9 col-lg-9 p-none">
                  <div class="gray-xs-f mb-xs">Default value (slider position) <span
                      class="requiredStar">*</span> <span class="ml-xs sprites_v3 filled-tooltip"
                                                          data-toggle="tooltip"
            ...
            <div class="row mb-xs">
              <div class="col-md-6 pl-none">
                <div class="col-md-6 col-lg-6 pl-none">
                  <div class="gray-xs-f mb-xs">Image for Minimum Value<span
                      class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                      data-html="true"
                  ...
                  <div class="form-group col-smthumb-2">
                    ...
                    <span id="removeUrl"
                          ...
                          onclick="removeImage(this);">X<a href="javascript:void(0)"
                                                           class="blue-link txt-decoration-underline pl-xs">Remove Image</a></span>
                    <div class="help-block with-errors red-txt"></div>
                  </div>
                </div>
              </div>
              <div class="col-md-6">
                <div class="col-md-6 col-lg-6 pl-none">
                  <div class="gray-xs-f mb-xs">Image for Maximum Value<span
                      class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                      data-html="true"
          ...
          <div id="ContinuousScale" style="display: none">
            ...
            <div class="row mb-xs">
              ...
              <div class="col-md-6">
                <div class="col-md-6 col-lg-4 p-none">
                  <div class="gray-xs-f mb-xs">Max Fraction Digits <span
                      class="requiredStar">*</span>
                    <span class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
          ...
          <div id="Location" style="display: none">
            <div class="mt-lg">
              <div class="gray-xs-f mb-xs">Use Current Location <span class="requiredStar">*</span>
                <span
                    class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
            ...
            <div class="row mt-lg">
              <div class="col-md-6 pl-none">
                <div class="col-md-12 col-lg-12 p-none">
                  <div class="gray-xs-f mb-xs">Placeholder Text (1 to 40 characters)<span
                      class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                      title="Enter an input hint to the user"></span></div>
                  <div class="form-group">
          ...
          <div id="Text" style="display: none">
            <div class="mt-lg">
              <div class="gray-xs-f mb-xs">Allow Multiple Lines? <span class="requiredStar">*</span>
                <span
                    class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
            ...
            <div class="row mt-md">
              <div class="col-md-6 pl-none">
                <div class="col-md-12 col-lg-12 p-none">
                  <div class="gray-xs-f mb-xs">Placeholder (1 to 50 characters)<span
                      class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                      title="Enter an input hint to the user"></span></div>
                  <div class="form-group">
              ...
              <div class="col-md-4">
                <div class="col-md-6 col-lg-4 p-none">
                  <div class="gray-xs-f mb-xs">Max Length <span
                      class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
            ...
            <div class="row mt-md">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 pl-none">
                ...
                <div class="col-md-12 col-lg-12 p-none">
                  <div class="gray-xs-f mb-xs">Special Validations<span
                      class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
            ...
            <div class="row">
              <div class="col-md-6 p-none">
                <div class="gray-xs-f mb-xs">Invalid Message (1 to 200 characters)<span
                    class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
          ...
          <div id="Height" style="display: none">
            <div class="mt-lg">
              <div class="gray-xs-f mb-xs">Measurement System <span class="requiredStar">*</span>
                <span
                    class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                    title="Select a suitable measurement system for height"></span></div>
              <div>
            ...
            <div class="row mt-md">
              <div class="col-md-6 pl-none">
                <div class="col-md-12 col-lg-12 p-none">
                  <div class="gray-xs-f mb-xs">Placeholder Text (1 to 20 characters)<span
                      class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                      title="Enter an input hint to the user"></span></div>
                  <div class="form-group">
          ...
          <div id="Timeinterval" style="display: none;">
            <div class="row mt-lg display__flex__center">
              <div class="col-md-2 pl-none">
                <div class="gray-xs-f mb-xs">Step value <span class="requiredStar">*</span> <span
                    class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
              ...
              <div class="col-md-2">
                <div class="gray-xs-f mb-xs">Default Value <span class="requiredStar">*</span> <span
                    class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
          ...
          <div id="Numeric" style="display: none;">
            <div class="mt-lg">
              <div class="gray-xs-f mb-xs">Style <span class="requiredStar">*</span> <span
                  class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                  title="Choose the kind of numeric input needed"></span></div>
              <div class="form-group">
	                  <span class="radio radio-info radio-inline p-45">
            ...
            <div class="row">
              <div class="col-md-6 pl-none">
                <div class="col-md-8 col-lg-8 p-none">
                  <div class="gray-xs-f mb-xs">Units (1 to 15 characters) <span
                      class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                      title="Enter the applicable units for the numeric input"></span></div>
                  <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="col-md-8 col-lg-8 p-none">
                  <div class="gray-xs-f mb-xs">Placeholder Text (1 to 30 characters) <span
                      class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                      title="Provide an input hint to the user"></span></div>
                  <div class="form-group">
            ...
            <div class="row mb-xs">
              <div class="col-md-6 pl-none">
                <div class="col-md-8 col-lg-8 p-none">
                  <div class="gray-xs-f mb-xs">Minimum Value <span
                      class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                      title="Enter minimum value allowed"></span></div>
                  <div class="form-group">
              ...
              <div class="col-md-6">
                <div class="col-md-8 col-lg-8 p-none">
                  <div class="gray-xs-f mb-xs">Maximum Value <span
                      class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                      title="Enter maximum value allowed"></span></div>
                  <div class="form-group">
          ...
          <div id="Date" style="display: none;">
            ...
            <div class="mt-lg">
              <div class="gray-xs-f mb-xs">Set allowed date range<span class="requiredStar">*</span>
                <span
                    class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
            ...
            <div id="customDateContainerId"
              ...
              <div class="row">
                <div class="col-md-6 pl-none">
                  <div class="col-md-8 col-lg-8 p-none">
                    <div class="gray-xs-f mb-xs">Minimum Date <span
                        class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                        title="Enter minimum date allowed."></span></div>
                    <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6  pl-none">
                  <div class="col-md-8 col-lg-8 p-none">
                    <div class="gray-xs-f mb-xs">Maximum Date <span
                        class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                        title="Enter maximum date allowed"></span></div>
                    <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6  pl-none">
                  <div class="col-md-8 col-lg-8 p-none">
                    <div class="gray-xs-f mb-xs">Default Date <span
                        class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                        title="Enter default date to be shown as selected"></span></div>
                    <div class="form-group">
                      <input type="text" class="form-control"
          ...
          <div id="Boolean" style="display: none;">
            <div class="clearfix"></div>
            <div class="mt-lg">
              <div class="gray-choice-f mb-xs">Choices <span class="ml-xs sprites_v3 filled-tooltip"
                                                             data-toggle="tooltip"
            ...
            <div class="row mt-xs" id="0">
              ...
              <c:if test="${questionnaireBo.branching}">
                <div class="col-md-3 pl-none">
                  <div class="gray-xs-f mb-xs">Destination Step <span
                      class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                      title="If there is branching applied to your questionnaire, you can  define destination steps for the Yes and No choices"></span>
                  </div>
                  <div class="form-group">
          ...
          <div id="ValuePicker" style="display: none;">
            <div class="mt-lg">
              <div class="gray-choice-f mb-xs">Values for the picker<span
                  class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
            ...
            <div class="row mt-sm" id="0">
              <div class="col-md-3 pl-none">
                <div class="gray-xs-f mb-xs">Display Text (1 to 20 characters)<span
                    class="requiredStar">*</span></div>
              </div>
              <div class="col-md-4 pl-none">
                <div class="gray-xs-f mb-xs">Value (1 to 50 characters)<span
                    class="requiredStar">*</span></div>
              </div>
              <div class="clearfix"></div>
          ...
          <div id="TextScale" style="display: none;">
            <div class="clearfix"></div>
            <div class="gray-choice-f mb-xs">Text Choices<span
            ...
            <div class="row">
              <div class="col-md-3 pl-none">
                <div class="gray-xs-f mb-xs">Display Text (1 to 100 characters)<span
                    class="requiredStar">*</span></div>
              </div>
              <div class="col-md-4 pl-none">
                <div class="gray-xs-f mb-xs">Value (1 to 50 characters)<span
                  ...
                  <c:forEach items="${questionnairesStepsBo.questionResponseSubTypeList}"
                    ...
                    <div class="text-scale row" id="${subtype.index}">
                      ...
                      <div class="col-md-2 pl-none mt__8">
                        <c:choose>
                          <c:when
                              test="${fn:length(questionnairesStepsBo.questionResponseSubTypeList) eq 8 }"><span
                              ...
                              onclick='addTextScale();'>+</span></span></c:when>
                          <c:otherwise><span class="addBtnDis addbtn mr-sm align-span-center"
                                             onclick='addTextScale();'>+</span></c:otherwise>
                        </c:choose>
                        <span
                            class="delete vertical-align-middle remBtnDis hide pl-md align-span-center"
            ...
            <div class="row mt-sm">
              <div class="col-md-6 pl-none">
                <div class="col-md-8 col-lg-8 p-none">
                  <div class="gray-xs-f mb-xs">Default slider position <span
                      class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
          ...
          <div id="TextChoice" style="display: none;">
            ...
            <div class="clearfix"></div>
            <div class="gray-choice-f mb-xs mt-md">Text Choices<span
                class="ml-xs sprites_v3 filled-tooltip"
                data-toggle="tooltip"
                ...
                <c:when
                  ...
                  <c:forEach items="${questionnairesStepsBo.questionResponseSubTypeList}"
                    ...
                    <div class="mt-xlg text-choice" id="${subtype.index}">
                      ...
                      <div class="col-md-3 pl-none">
                        <div class="gray-xs-f mb-xs">Value (1 to 100 characters)<span
                            class="requiredStar">*</span></div>
                        <div class="form-group mb-none">
                          <input type="text"
                      ...
                      <div class="col-md-2 pl-none">
                        <div class="gray-xs-f mb-xs">Mark as exclusive ? <span
                            class="requiredStar">*</span></div>
                        <div class="form-group">
            ...
            <div>
              ...
              <div class="textchoiceOtherCls" style="display: none;">
                ...
                <div class="mt-lg">
                  <div>
                    <span
                        class="gray-xs-f mb-xs pr-md">Include text field to specify 'Other' ?</span>
          ...
          <div id="ImageChoice" style="display: none;">
            <div class="mt-lg">
              <div class="gray-choice-f mb-xs">Image Choices<span
                  class="ml-xs sprites_v3 filled-tooltip"
                  data-toggle="tooltip"
            ...
            <div class="mt-sm row">
              <div>
                <div class="col-md-2 pl-none col-smthumb-2">
                  <div class="gray-xs-f mb-xs">Image <span class="requiredStar">*</span><span
                      class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                      data-html="true"
                ...
                <div class="col-md-2 pl-none col-smthumb-2">
                  <div class="gray-xs-f mb-xs">Selected Image <span
                ...
                <div class="col-md-2 pl-none">
                  <div class="gray-xs-f mb-xs">Display Text <span class="requiredStar">*</span><span
                      class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                      data-html="true" title="1 to 100 characters"></span></div>
                </div>
                <div class="col-md-2 col-lg-2 pl-none">
                  <div class="gray-xs-f mb-xs">Value <span class="requiredStar">*</span><span
                      class="ml-xs sprites_v3 filled-tooltip" data-toggle="tooltip"
                      data-html="true" title="1 to 50 characters"></span></div>
                </div>
                <c:if test="${questionnaireBo.branching}">
                  <div class="col-md-2 col-lg-2 pl-none">
                    <div class="gray-xs-f mb-xs">Destination Step <span
              ...
              <div class="col-xs-12 p-none">
                <div class="col-md-12 p-none">
                  <div>
			            ...
			            <label for="formulaBasedLogicId"><span class="tealtxt-md">Use formula-based conditional branching logic</span><span
