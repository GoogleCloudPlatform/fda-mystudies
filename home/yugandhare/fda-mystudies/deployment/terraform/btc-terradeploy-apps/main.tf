...
#7#
#7#   github {
#7#     owner = "GoogleCloudPlatform"
#7#     name  = "fda-mystudies"
#7#     push { branch = "^btc-terraform-deploy$" }
#7#   }
...
module "project" {
  ...
  shared_vpc              = "btc-terradeploy-networks"
  shared_vpc_subnets = [
    "projects/btc-terradeploy-networks/regions/us-east1/subnetworks/btc-terradeploy-gke-subnet",
  ]
  activate_apis = [
...
module "btc_terradeploy" {
  source  = "terraform-google-modules/cloud-dns/google"
  version = "~> 3.0.0"

  name       = "btc-terradeploy"
  project_id = module.project.project_id
  domain     = "btc-terradeploy.boston-technology.com."
  type       = "public"
...
module "btc_terradeploy_gke_cluster" {
  source  = "terraform-google-modules/kubernetes-engine/google//modules/safer-cluster-update-variant"
  version = "~> 11.1.0"

  # Required.
  name               = "btc-terradeploy-gke-cluster"
  project_id         = module.project.project_id
  region             = "us-east1"
  regional           = true
  network_project_id = "btc-terradeploy-networks"

  network                = "btc-terradeploy-network"
  subnetwork             = "btc-terradeploy-gke-subnet"
  ip_range_pods          = "btc-terradeploy-pods-range"
  ip_range_services      = "btc-terradeploy-services-range"
...
module "project_iam_members" {
  ...
  bindings = {
    "roles/logging.logWriter" = [
      "serviceAccount:${google_service_account.auth_server_gke_sa.account_id}@btc-terradeploy-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.hydra_gke_sa.account_id}@btc-terradeploy-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.response_datastore_gke_sa.account_id}@btc-terradeploy-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_builder_gke_sa.account_id}@btc-terradeploy-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_datastore_gke_sa.account_id}@btc-terradeploy-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.consent_datastore_gke_sa.account_id}@btc-terradeploy-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.enroll_datastore_gke_sa.account_id}@btc-terradeploy-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.user_datastore_gke_sa.account_id}@btc-terradeploy-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.participant_manager_gke_sa.account_id}@btc-terradeploy-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.triggers_pubsub_handler_gke_sa.account_id}@btc-terradeploy-apps.iam.gserviceaccount.com",
    ],
  }
}
