...
public class PersonalizedUserReportRepositoryTest {
	...
	public void LooksUpMostRecentReportForUserAndStudy() {
		...
		StudyInfoBO study1 = StudyInfoBO.builder()
				.customId("study 1")
				.name("Study 1")
				.build();

		StudyInfoBO study2 = StudyInfoBO.builder()
				.customId("study 2")
				.name("Study 2")
				.build();
		...
		PersonalizedUserReportBO report1 = PersonalizedUserReportBO.builder()
				.userDetails(user1)
				.studyInfo(study1)
				.reportTitle("Report 1")
				.reportContent("Report 1 content 1 for user 1")
				.build();
		PersonalizedUserReportBO report2 = PersonalizedUserReportBO.builder()
				.userDetails(user1)
				.studyInfo(study1)
				.reportTitle("Report 1")
				.reportContent("Report 1 content 2 for user 1")
				.build();
		PersonalizedUserReportBO report3 = PersonalizedUserReportBO.builder()
				.userDetails(user1)
				.studyInfo(study1)
				.reportTitle("Report 2")
				.reportContent("Report 2 content for user 1")
				.build();
		PersonalizedUserReportBO report4 = PersonalizedUserReportBO.builder()
				.userDetails(user2)
				.studyInfo(study1)
				.reportTitle("Report 1")
				.reportContent("Report 1 content for user 2")
				.build();
		PersonalizedUserReportBO report5 = PersonalizedUserReportBO.builder()
				.userDetails(user1)
				.studyInfo(study2)
				.reportTitle("Report 2")
				.reportContent("Report 2 content for user 1")
		...
		assertThat(
				personalizedUserReportRepository.findByUserDetailsUserIdAndStudyInfoCustomId("user_id1", "study 1"),
				containsInAnyOrder(
