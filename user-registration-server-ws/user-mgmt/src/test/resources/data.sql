...
INSERT INTO `org_info` (`id`, `name`, `org_id`, `created_on`, `created_by`, `modified_by`, `modified_date`) VALUES
	(1, 'organizations name', 'OrgName', '2020-03-03 15:35:27', 0, 0, '2020-03-12 15:25:14');

INSERT INTO `app_info` (`app_info_id`, `custom_app_id`, `org_info_id`, `created_on`, `app_name`, `created_by`, `modified_date`) VALUES
	(1, 'GCPMS001', 1, '2020-01-16 15:22:22', 'app-name-1', 0, '2020-03-12 15:17:56');
...
INSERT INTO `user_details` (`user_details_id`, `user_id`, `app_info_id`, `email`, `status`, `first_name`, `last_name`, `local_notification_flag`, `remote_notification_flag`,`touch_id`, `use_pass_code`, `verification_date`, `_ts`, `email_code`) VALUES
	(44, 'kR2g5m2pJPP0P31-WNFYK8Al7jBP0mJ-cTSFJJHJ4DewuCg', 1, 'cdash93@gmail.com', 1, 'test', 'user', 0, 0,  0, 0, '2020-01-30 20:21:28', '2020-02-05 19:11:05','1'),
	(45, 'kR2g5m2pJPP0P31-WNFYK8Al7jBP0mJ-cTSFJJHJ4DewuCg', 2, 'abc@xy', 2, 'test', 'user', 0, 0,  0, 0, '2020-01-30 20:21:28', '2020-02-05 19:11:05','1'),
	(46, 'kR2g5m2pJPP0P31-WNFYK8Al7jBP0mJ-cTSFJJHJ4DewuCg', 1, 'abc@gmail.com', 1, 'test', 'user', 0, 0,  0, 0, '2020-01-30 20:21:28', '2020-02-05 19:11:05','1'),
	(47, 'gnDoLZHKy0j27Eo-ap8cnZnvQvp7kBN-qylvroBJV7IssDk', 1, 'abc1234@gmail.com', 2, 'test', 'user', 0, 0,  0, 0, '2020-01-30 20:21:28', '2020-02-05 19:11:05','1');
