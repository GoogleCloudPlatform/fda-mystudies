      ...
      if (StringUtils.isNotEmpty(reqBean.getSubject())
        ...
        if (isEmailSent) {
          commonService.createAuditLog(
              "",
              "'Feedback' content successfully emailed",
              "Content submitted by app user via 'Feedback' form in mobile app, successfully emailed to <destination email address>.",
        ...
        commonService.createAuditLog(
            "",
            "'Feedback' content  email failure",
            "Content submitted by app user via 'Feedback' form in mobile app, could not be emailed to <destination email address>.",
            AppConstants.AUDIT_LOG_MOBILE_APP_CLIENT_ID,
            "",
            "",
            AppConstants.APP_LEVEL_ACCESS);
    ...
    try {
      if (StringUtils.isNotEmpty(reqBean.getSubject())
        ...
        if (isEmailSent) {
          commonService.createAuditLog(
              "",
              "'Contact Us' content successfully emailed ",
              "Content submitted by app user via 'Contact Us' form in mobile app, successfully emailed to <destination email address>.",
              AppConstants.AUDIT_LOG_MOBILE_APP_CLIENT_ID,
              "",
              "",
              AppConstants.APP_LEVEL_ACCESS);
        ...
        commonService.createAuditLog(
            "",
            "'Contact Us' content email failure ",
            "Content submitted by app user via 'Contact Us' form in mobile app, could not be emailed to <destination email address>.",
            AppConstants.AUDIT_LOG_MOBILE_APP_CLIENT_ID,
            "",
            "",
            AppConstants.APP_LEVEL_ACCESS);
