...
public class UserRegistrationController {
  ...
  private UserDetailsBO getUserDetails(UserRegistrationForm form) {
    ...
    if (form.getUserId() != null) {
      userDetailsBO.setUserId(form.getUserId());
    }

    if (form.getEmailId() != null) {
      userDetailsBO.setEmail(form.getEmailId());
    }
    ...
    if (form.isTouchId() != AppConstants.FALSE) {
      userDetailsBO.setTouchId(form.isTouchId());
    }
