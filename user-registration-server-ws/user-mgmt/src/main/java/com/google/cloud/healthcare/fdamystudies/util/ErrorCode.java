...
public enum ErrorCode {
  ...
  EC_115(115, "User Id is missing"),

  EC_118(118, "System error found"),

  EC_119(119, "Password is missing"),

  EC_120(120, "Oops, something went wrong. Please try again after sometime"),

  EC_126(126, "appId is missing"),

  EC_127(127, "orgId is missing"),

  EC_128(128, "User form is empty"),
  ...
  EC_132(132, "Access Token is missing"),

  EC_133(133, "Code is missing"),

  EC_134(134, "Verification form is empty"),

  EC_135(135, "Invalid userId or email code"),

  // EC_136(136, "Invalid email code"),
  ...
  EC_1041(
      104,
      "Your account is not verified. Please verify your account by clicking on verification link which has been sent to your registered email. If not received, would you like to resend verification link?") // Unknown
// Error
;
