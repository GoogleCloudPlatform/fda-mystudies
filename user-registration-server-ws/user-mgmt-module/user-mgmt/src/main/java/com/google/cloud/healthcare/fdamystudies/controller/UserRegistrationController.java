...
public class UserRegistrationController {
  ...
  public ResponseEntity<?> registerUser(
    ...
    try {
      authServerResponse = userManagementUtil.registerUserInAuthServer(userForm, appId);

      if (authServerResponse.getHttpStatusCode() != 201) {
  ...
  void deleteUserFromAuthServer(AuthRegistrationResponse authServerResponse, String emailId) {
    DeleteAccountInfoResponseBean deleteResponse =
        userManagementUtil.deleteUserInfoInAuthServer(authServerResponse.getUserId());
  ...
  private ResponseEntity<?> makeAuthServerErrorResponse(
      AuthRegistrationResponse authServerResponse, HttpServletResponse response) {
    UserRegistrationResponse registrationResponse = new UserRegistrationResponse();
    Integer httpCode = authServerResponse != null ? authServerResponse.getHttpStatusCode() : 500;
    switch (httpCode) {
      case 400:
      case 401:
        return makeServerError(
