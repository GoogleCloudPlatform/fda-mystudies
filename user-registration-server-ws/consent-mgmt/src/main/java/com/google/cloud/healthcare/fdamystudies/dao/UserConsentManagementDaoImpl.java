  ...
  public ParticipantStudiesBO getParticipantStudies(Integer studyId, String userId) {
    ...
    try (Session session = entityManagerFactory.unwrap(SessionFactory.class).openSession()) {
      ...
      if (studiesBoList.isEmpty()) {
        logger.warn("UserConsentManagementDaoImpl getParticipantStudies() unable to find study.");
      }
      ...
      if (!StringUtils.isEmpty(userId)) {
        ...
        if (userDetailsBoList.isEmpty()) {
          logger.warn("UserConsentManagementDaoImpl getParticipantStudies() unable to find user.");
        }
