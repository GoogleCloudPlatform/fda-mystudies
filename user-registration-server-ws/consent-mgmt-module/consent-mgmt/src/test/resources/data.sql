INSERT INTO `app_info` (`app_info_id`, `custom_app_id`, `created_on`, `app_name`, `created_by`, `modified_date`) VALUES
	(1, 'app-id-cust', '2020-01-16 15:22:22', 'app-name-1', 0, '2020-03-12 15:17:56');
...
INSERT INTO `participant_study_info` (`participant_study_info_id`, `participant_id`, `study_info_id`, `participant_registry_site_id`, `site_id`, `user_details_id`, `status`, `bookmark`, `enrolled_date`, `completion`, `adherence`, `withdrawal_date`) VALUES
	(101, '1', 1, 33, 1, 44, 'Withdrawn', 1, '2020-02-06 14:07:29', 45, 20, '2020-02-10 14:03:14'),
