...
CREATE TABLE personalized_user_report (id integer NOT NULL, activity_date_time TIMESTAMP DEFAULT CURRENT_TIMESTAMP, report_content varchar(255), report_title varchar(255), study_info_id INTEGER, user_id INTEGER, primary key (id));
