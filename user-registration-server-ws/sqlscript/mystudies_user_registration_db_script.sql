...
-- Dumping data for table mystudies_userregistration.locations: ~1 rows (approximately)	
/*!40000 ALTER TABLE `locations` DISABLE KEYS */;	
INSERT INTO `locations` (`id`, `created`, `created_by`, `custom_id`, `description`, `is_default`, `name`, `status`) VALUES	
	(1, NULL, 0, 'location1', 'default location for creating site for open study', 'Y', 'default_location', 'A');
