...
module "btcsoft_dev_mystudies_firestore_data" {
  source  = "terraform-google-modules/bigquery/google"
  version = "~> 4.3.0"

  dataset_id = "btcsoft_dev_mystudies_firestore_data"
...
module "project_iam_members" {
  ...
  bindings = {
    "roles/bigquery.dataEditor" = [
      "serviceAccount:btcsoft-dev-firebase@appspot.gserviceaccount.com",
    ],
    "roles/bigquery.jobUser" = [
      "serviceAccount:btcsoft-dev-firebase@appspot.gserviceaccount.com",
    ],
    "roles/cloudsql.client" = [
      "serviceAccount:bastion@btcsoft-dev-networks.iam.gserviceaccount.com",
      "serviceAccount:auth-server-gke-sa@btcsoft-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:hydra-gke-sa@btcsoft-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:response-datastore-gke-sa@btcsoft-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:study-builder-gke-sa@btcsoft-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:study-datastore-gke-sa@btcsoft-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:consent-datastore-gke-sa@btcsoft-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:enroll-datastore-gke-sa@btcsoft-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:user-datastore-gke-sa@btcsoft-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:participant-manager-gke-sa@btcsoft-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:triggers-pubsub-handler-gke-sa@btcsoft-dev-apps.iam.gserviceaccount.com",
    ],
  }
}

module "btcsoft_dev_mystudies_consent_documents" {
  source  = "terraform-google-modules/cloud-storage/google//modules/simple_bucket"
  version = "~> 1.4"

  name       = "btcsoft-dev-mystudies-consent-documents"
  project_id = module.project.project_id
  location   = "us-east1"
...
module "btcsoft_dev_mystudies_study_resources" {
  source  = "terraform-google-modules/cloud-storage/google//modules/simple_bucket"
  version = "~> 1.4"

  name       = "btcsoft-dev-mystudies-study-resources"
  project_id = module.project.project_id
  location   = "us-east1"
...
module "btcsoft_dev_mystudies_sql_import" {
  source  = "terraform-google-modules/cloud-storage/google//modules/simple_bucket"
  version = "~> 1.4"

  name       = "btcsoft-dev-mystudies-sql-import"
  project_id = module.project.project_id
  location   = "us-east1"
