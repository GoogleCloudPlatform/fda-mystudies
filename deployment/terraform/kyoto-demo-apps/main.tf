...
module "project" {
  ...
  shared_vpc_subnets = [
    "projects/kyoto-demo-networks/regions/asia-northeast1/subnetworks/kyoto-demo-gke-subnet",
  ]
  activate_apis = [
...
module "kyoto_demo" {
  ...
  domain     = "kyoto-demo.clipcrow.com."
  type       = "public"
...
module "kyoto_demo_gke_cluster" {
  ...
  regional           = true
  network_project_id = "kyoto-demo-networks"

  network                = "kyoto-demo-network"
  subnetwork             = "kyoto-demo-gke-subnet"
  ip_range_pods          = "kyoto-demo-pods-range"
  ip_range_services      = "kyoto-demo-services-range"
...
module "project_iam_members" {
  ...
  bindings = {
    "roles/logging.logWriter" = [
      "serviceAccount:${google_service_account.auth_server_gke_sa.account_id}@kyoto-demo-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.hydra_gke_sa.account_id}@kyoto-demo-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.response_datastore_gke_sa.account_id}@kyoto-demo-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_builder_gke_sa.account_id}@kyoto-demo-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_datastore_gke_sa.account_id}@kyoto-demo-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.consent_datastore_gke_sa.account_id}@kyoto-demo-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.enroll_datastore_gke_sa.account_id}@kyoto-demo-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.user_datastore_gke_sa.account_id}@kyoto-demo-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.participant_manager_gke_sa.account_id}@kyoto-demo-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.triggers_pubsub_handler_gke_sa.account_id}@kyoto-demo-apps.iam.gserviceaccount.com",
    ],
  }
}
