...
# You may obtain a copy of the License at below link
#
...
module "project" {
  ...
  shared_vpc_subnets = [
    "projects/btc-qa-networks/regions/us-east1/subnetworks/btc-qa-gke-subnet",
  ]
  activate_apis = [
...
module "btc_qa" {
  ...
  domain     = "btc-qa.boston-technology.com."
  type       = "public"
...
module "btc_qa_gke_cluster" {
  ...
  region             = "us-east1"
  regional           = true
  network_project_id = "btc-qa-networks"

  network                = "btc-qa-network"
  subnetwork             = "btc-qa-gke-subnet"
  ip_range_pods          = "btc-qa-pods-range"
  ip_range_services      = "btc-qa-services-range"
  master_ipv4_cidr_block = "192.168.0.0/28"
  master_authorized_networks = [
    {
      cidr_block   = "0.0.0.0/0"
      display_name = "btc-qa-ip"
    },
  ]
  istio                   = true
...
module "project_iam_members" {
  ...
  bindings = {
    "roles/logging.logWriter" = [
      "serviceAccount:${google_service_account.auth_server_gke_sa.account_id}@btc-qa-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.hydra_gke_sa.account_id}@btc-qa-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.response_datastore_gke_sa.account_id}@btc-qa-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_builder_gke_sa.account_id}@btc-qa-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_datastore_gke_sa.account_id}@btc-qa-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.consent_datastore_gke_sa.account_id}@btc-qa-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.enroll_datastore_gke_sa.account_id}@btc-qa-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.user_datastore_gke_sa.account_id}@btc-qa-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.participant_manager_gke_sa.account_id}@btc-qa-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.triggers_pubsub_handler_gke_sa.account_id}@btc-qa-apps.iam.gserviceaccount.com",
    ],
  }
}
