...
# Prefix for firestore bigquery dataset ID.
# final name will be ${NEW_BIGQUERY_PREFIX}_my_studies_firestore_data.
...
# Name of the github organization that would hold the deployment fork.
