...
module "images_bucket" {
  ...
  name       = "validcare-research-images"
...
module "my_studies_consent_documents_bucket" {
  ...
  name        = "validcare-research-my-studies-consent-documents"
  project_id  = var.project_id
  location    = var.storage_location
...
module "my_studies_fda_resources_bucket" {
  ...
  name        = "validcare-research-my-studies-fda-resources"
  project_id  = var.project_id
  location    = var.storage_location
...
module "my_studies_institution_resources_bucket" {
  ...
  name        = "validcare-research-my-studies-institution-resources"
  project_id  = var.project_id
  location    = var.storage_location
...
module "my_studies_firestore_data_bucket" {
  ...
  name       = "validcare-research-my-studies-firestore-data"
  project_id = var.project_id
  location   = var.storage_location
...
module "my_studies_firestore_data_bigquery" {
  ...
  dataset_id = "validcare-research_my_studies_firestore_data"
  project_id = var.project_id
  location   = var.storage_location
}
