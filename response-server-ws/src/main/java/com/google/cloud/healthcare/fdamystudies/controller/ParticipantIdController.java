...
public class ParticipantIdController {
  ...
  public ResponseEntity<?> addParticipantIdentifier(
    ...
    if (enrollmentTokenIdentifierBean == null
      ...
      ErrorBean errorBean = AppUtil.dynamicResponse(ErrorCode.EC_701.code(),
          ErrorCode.EC_701.errorMessage(), AppConstants.ERROR_STR, ErrorCode.EC_701.errorMessage());
    ...
    try {
      ...
      ErrorBean errorBean = AppUtil.dynamicResponse(ErrorCode.EC_703.code(),
          ErrorCode.EC_703.errorMessage(), AppConstants.ERROR_STR, e.getMessage());
