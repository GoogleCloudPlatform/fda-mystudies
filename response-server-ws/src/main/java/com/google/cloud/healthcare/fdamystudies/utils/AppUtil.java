...
public class AppUtil {
  ...
  public static ErrorBean dynamicResponse(int code, String userMessage, String type,
  ...
  public static String makeParticipantCollectionName(String studyId, String siteId) {
    if (!StringUtils.isBlank(studyId) && !StringUtils.isBlank(siteId)) {
      return studyId + AppConstants.HYPHEN + siteId + AppConstants.HYPHEN
          + AppConstants.PARTICIPANTS_NAME;
    }
    return null;
  }
