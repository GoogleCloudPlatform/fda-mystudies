...
CREATE TABLE IF NOT EXISTS `participant_enrollment_history` (
  ...
  `user_details_id` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `withdrawal_time_user_details_id_study_info_id_idx` (`withdrawal_time`,`user_details_id`,`study_info_id`),
  KEY `withdrawal_time_user_details_id_idx` (`withdrawal_time`,`user_details_id`),
