...
1. Update the landing page logo as desired replacing the image [`landing-logo.png`](src/assets/images/branding/landing-logo.png) (ensure you keep the same file name)
1. Update the favicon as desired replacing the image [`favicon_pm.png`](src/assets/images/branding/favicon_pm.png) (ensure you keep the same file name)
