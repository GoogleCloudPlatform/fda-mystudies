...
1. Update landing logo as desired, for example in [`landing-logo.png`](src/assets/images/branding/landing-logo.png)
1. Update favicon as desired, for example in [`favicon_pm.png`](src/assets/images/branding/favicon_pm.png)
