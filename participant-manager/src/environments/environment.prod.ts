...
export const environment = {
  ...
  participantManagerDatastoreUrl:
    '//participants.btc-dev.boston-technology.com/participant-manager-datastore',
  baseHref: '/participant-manager/',
  hydraLoginUrl:
    'https://participants.btc-dev.boston-technology.com/oauth2/auth',
  authServerUrl:
    'https://participants.btc-dev.boston-technology.com/auth-server',
  authServerRedirectUrl:
    'https://participants.btc-dev.boston-technology.com/auth-server/callback',
