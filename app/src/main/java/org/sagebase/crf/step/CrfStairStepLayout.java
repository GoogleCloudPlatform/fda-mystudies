...
public class CrfStairStepLayout extends ActiveStepLayout implements CrfTaskStatusBarManipulator {
    ...
    public void doUIAnimationPerSecond() {
        ...
        stairCounter++;
        if (stairCounter >= crfStairStep.stairInterval) {
            stairCounter = 0;
    ...
    public void start() {
        ...
        stairCounter = 0;
        String startInstruction = getContext().getString(R.string.crf_stand_still);
        crfInstructionText.setText(startInstruction);
        speakText(startInstruction);
    }
    ...
    public void onInit(int i) {
        ...
        if (i == TextToSpeech.SUCCESS) {
            speakText(getContext().getString(R.string.crf_stand_still));
        }
    }
