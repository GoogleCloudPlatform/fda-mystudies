...
module "project" {
  ...
  shared_vpc_subnets = [
    "projects/fdav1-dev-networks/regions/us-central1/subnetworks/fdav1-dev-gke-subnet",
  ]
  activate_apis = [
...
module "fdav1_dev_gke_cluster" {
  source  = "terraform-google-modules/kubernetes-engine/google//modules/safer-cluster-update-variant"
  version = "~> 10.0.0"

  # Required.
  name               = "fdav1-dev-gke-cluster"
  project_id         = module.project.project_id
  region             = "us-central1"
  regional           = true
  network_project_id = "fdav1-dev-networks"

  network                = "fdav1-dev-network"
  subnetwork             = "fdav1-dev-gke-subnet"
  ip_range_pods          = "fdav1-dev-pods-range"
  ip_range_services      = "fdav1-dev-services-range"
