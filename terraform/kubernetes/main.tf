...
resource "kubernetes_secret" "shared_secrets" {
  ...
  data = {
    consent_bucket_name               = "fms-dev-mystudies-consent-documents"
    study_resources_bucket_name       = "fms-dev-mystudies-study-resources"
    institution_resources_bucket_name = "fms-dev-mystudies-institution-resources"
    base_url                          = "https://participants.fms-dev.solaro.jp"
    studies_base_url                  = "https://studies.fms-dev.solaro.jp"
    firestore_project_id              = "fms-dev-firebase"
...
resource "google_service_account_key" "apps_service_account_keys" {
  ...
  service_account_id = "${each.key}@fms-dev-apps.iam.gserviceaccount.com"
}
