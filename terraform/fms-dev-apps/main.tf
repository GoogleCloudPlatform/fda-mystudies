...
module "project" {
  ...
  shared_vpc_subnets = [
    "projects/fms-dev-networks/regions/asia-northeast1/subnetworks/fms-dev-gke-subnet",
  ]
  activate_apis = [
...
module "fms_dev_gke_cluster" {
  source  = "terraform-google-modules/kubernetes-engine/google//modules/safer-cluster-update-variant"
  version = "~> 11.1.0"

  # Required.
  name               = "fms-dev-gke-cluster"
  project_id         = module.project.project_id
  region             = "asia-northeast1"
  regional           = true
  network_project_id = "fms-dev-networks"

  network                = "fms-dev-network"
  subnetwork             = "fms-dev-gke-subnet"
  ip_range_pods          = "fms-dev-pods-range"
  ip_range_services      = "fms-dev-services-range"
  master_ipv4_cidr_block = "192.168.0.0/28"
  master_authorized_networks = [
    {
      cidr_block   = "0.0.0.0/0"
      display_name = "FDA-MyStudies-dev"
    },
  ]
  istio                   = true
...
module "project_iam_members" {
  ...
  bindings = {
    "roles/logging.logWriter" = [
      "serviceAccount:${google_service_account.auth_server_gke_sa.account_id}@fms-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.hydra_gke_sa.account_id}@fms-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.response_datastore_gke_sa.account_id}@fms-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_builder_gke_sa.account_id}@fms-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.study_datastore_gke_sa.account_id}@fms-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.consent_datastore_gke_sa.account_id}@fms-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.enroll_datastore_gke_sa.account_id}@fms-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.user_datastore_gke_sa.account_id}@fms-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.participant_manager_gke_sa.account_id}@fms-dev-apps.iam.gserviceaccount.com",
      "serviceAccount:${google_service_account.triggers_pubsub_handler_gke_sa.account_id}@fms-dev-apps.iam.gserviceaccount.com",
    ],
  }
}
