...
public class ConsentStoreApisTest extends BaseMockIT {
  ...
  public List<ConsentArtifact> getConsentArtifact() {
    ...
    metadata.put(
        PDF_PATH,
        "31jan2022/554cf0f8-9eb1-43bf-b03f-9565f6b6bb7a-18a428eaj1e49x4fa4qa477u4d6e7ee091a2/1.1_01312022073150.pdf");
    ...
    consentArtifact.setName(
        "projects/test-project/locations/us-east4/datasets/test-consent/consentStores/test-consent/consentArtifacts/0e787edf-404d-4f6b-835e-97b04b0f284b");
