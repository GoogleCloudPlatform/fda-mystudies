         ...
         <!-- Start Section-->
                         ...
                         <div class="row">
                           ...
                           <div class="col-md-6">
                                ...
                                <div class="form-group mb-none">
                                    <input type="url" class="form-control" value="${appBo.appTermsUrl}" name="appTermsUrl" 
                            ...
                            <div class="clearfix"></div>
                              ...
                              <div class="col-md-6 pl-none mt-lg">
                                ...
                                <div class="form-group mb-none">
                                    <input type="url" class="form-control" value="${appBo.appPrivacyUrl}" name="appPrivacyUrl" 
                                    pattern="^(http:\/\/|https:\/\/)[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$"
                           ...
                           <div class="col-md-6">
                            ...
                            <div class="clearfix"></div>
                              ...
                              <div class="col-md-6 pl-none mt-lg">
                                ...
                                <div class="form-group mb-none">
                                    <input type="url" class="form-control" value="${appBo.appStoreUrl}" name="appStoreUrl" id="appStoreUrlId"
                                    pattern="^(http:\/\/|https:\/\/)[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$"
                   					title="Include http://" maxlength="250" 
                  					data-pattern-error="Please enter a valid URL" required data-error="Please fill out this field"/>
                                    <div class="help-block with-errors red-txt"></div>
                           ...
                           <div class="col-md-6">
                                ...
                                <div class="form-group mb-none">
                                    <input type="url" class="form-control" value="${appBo.playStoreUrl}" name="playStoreUrl" id="playStoreUrlId"
                                    pattern="^(http:\/\/|https:\/\/)[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$"
                   					title="Include http://" maxlength="250" 
                  					data-pattern-error="Please enter a valid URL" required data-error="Please fill out this field"/>
                                    <div class="help-block with-errors red-txt"></div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-none">
                                    <input type="url" class="form-control" value="${appBo.appWebsiteUrl}" name="appWebsiteUrl"
                                    pattern="^(http:\/\/|https:\/\/)[a-z0-9]+([\-\.]{1}[a-z0-9]+)*\.[a-z]{2,5}(:[0-9]{1,5})?(\/.*)?$"
                   					title="Include http://" maxlength="100" 
                  					data-pattern-error="Please enter a valid URL" required data-error="Please fill out this field"/>
                                    <div class="help-block with-errors red-txt"></div>
