         ...
         <!-- Start Section-->
                ...
                <div class="clearfix"></div>
                           ...
                           <div class="col-md-6">
                                ...
                                <div class="form-group mb-none">
                                    <input type="number" min="0" class="form-control ios" value= "${appBo.iosAppBuildVersion}" name="iosAppBuildVersion" required data-error="Please fill out this field"/>
                                    <div class="help-block with-errors red-txt"></div>
                                </div>
                            </div>
                        ...
                        <span class="radio radio-inline">
                           ...
                           <div class="col-md-6 pl-none">
                                ...
                                <div class="form-group mb-none">
                                    <input type="number" min="0" class="form-control android" value= "${appBo.versionInfoBO.android}" name="androidAppBuildVersion" required data-error="Please fill out this field"/>
                                    <div class="help-block with-errors red-txt"></div>
                                </div>
                            </div>
