            ...
            <div class="login pt-lg">
              <div class="mb-lg form-group">
                <input type="text" class="input-field wow_input" id="email" name="username"
                       ...
                       placeholder="Email address" required oninvalid="this.setCustomValidity('Please fill out this field')" maxlength="100"
              ...
              <div class="mb-lg form-group">
                <input type="password" class="input-field wow_input" id="password"
                       placeholder="Password" required  oninvalid="this.setCustomValidity('Please fill out this field')" maxlength="64"
                       data-error="Please complete this field"
            ...
            <div class="pwd dis-none">
              ...
              <div class="mb-lg form-group">
                <input type="text" class="input-field wow_input" id="emailReg" name="email"
                       ...
                       data-pattern-error="Email address is invalid" required oninvalid="this.setCustomValidity('Please fill out this field')" maxlength="100"
                       data-error="Please complete this field"
