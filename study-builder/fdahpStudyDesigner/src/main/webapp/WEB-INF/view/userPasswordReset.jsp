            ...
            <c:if test="${not isInactiveUser && isValidToken}">
              ...
              <div class="mb-lg form-group">
                <input type="password" class="input-field wow_input"
                       ...
                       placeholder="New password*" required oninvalid="this.setCustomValidity('Please fill out this field')"
              ...
              <div class="mb-lg form-group">
                <input type="password" class="input-field wow_input"
                       ...
                       placeholder="Confirm new password*" required oninvalid="this.setCustomValidity('Please fill out this field')" autocomplete="off"/>
                <div class="help-block with-errors red-txt"></div>
              </div>
              <div class="mb-lg form-group">
