                ...
                <div class="col-xs-6">
                  <div class="mb-lg form-group">
                    <input type="text"
                           ...
                           required oninvalid="this.setCustomValidity('Please fill out this field')" readonly="readonly" autocomplete="off"/>
                    <div class="help-block with-errors red-txt"></div>
                  </div>
                </div>
                <div class="col-xs-6">
                ...
                <div class="col-xs-6">
                  <div class="mb-lg form-group">
                    <input type="password" class="input-field wow_input"
                           ...
                           placeholder="Password*" required oninvalid="this.setCustomValidity('Please fill out this field')"
                ...
                <div class="col-xs-6">
                  <div class="mb-lg form-group">
                    <input type="password" class="input-field wow_input"
                           ...
                           placeholder="Confirm password*" required oninvalid="this.setCustomValidity('Please fill out this field')" autocomplete="off"/>
                    <div class="help-block with-errors red-txt"></div>
                  </div>
                </div>
