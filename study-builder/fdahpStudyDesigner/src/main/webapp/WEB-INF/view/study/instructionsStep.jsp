...
<div class="col-sm-10 col-rc white-bg p-none">
  ...
  <form:form action="/studybuilder/adminStudies/saveOrUpdateInstructionStep.do?_S=${param._S}"
    ...
    <div class="right-content-body">
      ...
      <div class="form-group">
        <input type="text" class="form-control" required oninvalid="this.setCustomValidity('Please fill out this field')" name="instructionTitle"
               id="instructionTitle"
        ...
        <div class="col-md-4 col-lg-3 p-none">
          ...
          <div class="form-group">
            <select name="questionnairesStepsBo.destinationStep" id="destinationStepId"
                    data-error="Please choose one title" class="selectpicker" required oninvalid="this.setCustomValidity('Please fill out this field')">
