...
<div class="col-sm-10 col-rc white-bg p-none">
  <form:form
      action="/studybuilder/adminStudies/saveOrDoneChecklist.do?${_csrf.parameterName}=${_csrf.token}&_S=${param._S}"
      id="checklistForm" role="form" method="post" autocomplete="off" enctype="multipart/form-data">
    ...
    <div class="right-content-head">
      <div class="text-right">
        ...
        <c:if test="${empty permission}">
          <div class="dis-line form-group mb-none mr-sm">
            <button type="button" class="btn btn-default gray-btn" id="saveChecklistId">Save
            </button>
          </div>

          <div class="dis-line form-group mb-none">
            <button type="button" class="btn btn-primary blue-btn" id="doneChecklistId">Done
            </button>
          </div>
        </c:if>
      </div>
        ...
        <div class="checkbox checkbox-inline p-45 pb-md">
          <div>
            <input type="checkbox" id="inlineCheckbox1" class="class" name="checkbox1"
                   <c:if test="${checklist.checkbox1}">checked</c:if> required oninvalid="this.setCustomValidity('Please fill out this field')">
        ...
        <div class="checkbox checkbox-inline p-45 pb-md">
          <div>
            <input type="checkbox" id="inlineCheckbox2" class="class" name="checkbox2"
                   <c:if test="${checklist.checkbox2}">checked</c:if> required oninvalid="this.setCustomValidity('Please fill out this field')">
        ...
        <div class="checkbox checkbox-inline p-45 pb-md">
          <div>
            <input type="checkbox" id="inlineCheckbox3" class="class" name="checkbox3"
                   <c:if test="${checklist.checkbox3}">checked</c:if> required oninvalid="this.setCustomValidity('Please fill out this field')">
        ...
        <div class="checkbox checkbox-inline p-45 pb-md">
          <div>
            <input type="checkbox" id="inlineCheckbox5" class="class" name="checkbox5"
                   <c:if test="${checklist.checkbox5}">checked</c:if> required oninvalid="this.setCustomValidity('Please fill out this field')">
        ...
        <div class="checkbox checkbox-inline p-45 pb-md">
          <div>
            <input type="checkbox" id="inlineCheckbox6" class="class" name="checkbox6"
                   <c:if test="${checklist.checkbox6}">checked</c:if> required oninvalid="this.setCustomValidity('Please fill out this field')">
        ...
        <div class="checkbox checkbox-inline p-45 pb-md">
          <div>
            <input type="checkbox" id="inlineCheckbox7" class="class" name="checkbox7"
                   <c:if test="${checklist.checkbox7}">checked</c:if> required oninvalid="this.setCustomValidity('Please fill out this field')">
        ...
        <div class="checkbox checkbox-inline p-45 pb-md">
          <div>
            <input type="checkbox" id="inlineCheckbox8" class="class" name="checkbox8"
                   <c:if test="${checklist.checkbox8}">checked</c:if> required oninvalid="this.setCustomValidity('Please fill out this field')">
        ...
        <div class="checkbox checkbox-inline p-45 pb-md">
          <div>
            <input type="checkbox" id="inlineCheckbox9" class="class" name="checkbox9"
                   <c:if test="${checklist.checkbox9}">checked</c:if> required oninvalid="this.setCustomValidity('Please fill out this field')">
        ...
        <div class="checkbox checkbox-inline p-45 pb-md">
          <div>
            <input type="checkbox" id="inlineCheckbox10" class="class" name="checkbox10"
                   <c:if test="${checklist.checkbox10}">checked</c:if> required oninvalid="this.setCustomValidity('Please fill out this field')">
        ...
        <div class="checkbox checkbox-inline p-45 pb-md">
          <div>
            <input type="checkbox" id="inlineCheckbox11" class="class" name="checkbox11"
                   <c:if test="${checklist.checkbox11}">checked</c:if> required oninvalid="this.setCustomValidity('Please fill out this field')">
        ...
        <div class="checkbox checkbox-inline p-45 pb-md">
          <div>
            <input type="checkbox" id="inlineCheckbox12" class="class" name="checkbox12"
                   <c:if test="${checklist.checkbox12}">checked</c:if> required oninvalid="this.setCustomValidity('Please fill out this field')">
