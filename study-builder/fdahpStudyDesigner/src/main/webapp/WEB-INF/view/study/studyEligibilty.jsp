    ...
    <div class="right-content-body">
      <div class="mb-xlg form-group" id="eligibilityOptDivId">
        ...
        <span class="radio radio-info radio-inline p-45"><input
            ...
            name="eligibilityMechanism" required oninvalid="this.setCustomValidity('Please fill out this field')"
        ...
        <div>
          ...
          <div class="form-group elaborateClass">
            <textarea class="form-control" rows="1" id="comment"
                      maxlength="230" required oninvalid="this.setCustomValidity('Please fill out this field')"
