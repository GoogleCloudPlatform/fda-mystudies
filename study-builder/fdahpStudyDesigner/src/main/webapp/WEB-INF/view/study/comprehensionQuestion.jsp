              ...
              <div class='col-md-3'>
                <div class="form-group">
                  <select class='selectpicker wid100' name="responseList[0].correctAnswer"
                          id="correctAnswerId0" required  data-error="Please fill out this field" data-error='Please choose one option'>
              ...
              <div class='col-md-3'>
                <div class="form-group">
                  <select class='selectpicker wid100' name="responseList[1].correctAnswer"
                          id="correctAnswerId1" required  data-error="Please fill out this field" data-error='Please choose one option'>
                    <option value=''>Select</option>
                    <option value="true">Yes</option>
                    <option value="false">No</option>
                  </select>
