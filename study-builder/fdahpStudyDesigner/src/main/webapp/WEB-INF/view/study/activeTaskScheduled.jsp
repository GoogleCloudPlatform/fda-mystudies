        ...
        <span class="form-group m-none dis-inline vertical-align-middle pr-md">
          <c:choose>
            <c:when test="${activeTaskBo.activeTaskFrequenciesBo.isStudyLifeTime}"><input
                ...
                required oninvalid="this.setCustomValidity('Please fill out this field')" <c:if
      ...
      <div class="dailyStartCls col-md-3 pl-none">
        <span class="form-group m-none dis-inline vertical-align-middle pr-md">
          ...
          <input id="startDate" type="text"
                 ...
                 placeholder="Choose date" required oninvalid="this.setCustomValidity('Please fill out this field')" name="activeTaskLifetimeStart"
      ...
      <div class="col-md-6 pr-none">
        <span class="form-group m-none dis-inline vertical-align-middle pr-md">
          ...
          <input id="days" type="text"
                 ...
                 name="repeatActiveTask" placeholder="No of times" required oninvalid="this.setCustomValidity('Please fill out this field')"
      ...
      <div class="dailyContainer">
        <c:if test="${fn:length(activeTaskBo.activeTaskFrequenciesList) eq 0}">
          <div class="time-opts mt-md dailyTimeDiv" id="0">
            <span class="form-group m-none dis-inline vertical-align-middle pr-md">
              <input id="time0" type="text" name="activeTaskFrequenciesList[0].frequencyTime" required oninvalid="this.setCustomValidity('Please fill out this field')"
            ...
            <div class="time-opts mt-md dailyTimeDiv" id="${frequeincesVar.index}">
              ...
              <span class="form-group m-none dis-inline vertical-align-middle pr-md">
                <input id="time${frequeincesVar.index}" type="text"
                       name="activeTaskFrequenciesList[${frequeincesVar.index}].frequencyTime" required oninvalid="this.setCustomValidity('Please fill out this field')"
                       class="form-control clock dailyClock ${(activeTaskBo.isDuplicate > 0)?'cursor-none' : ''}"
                       placeholder="Time" onclick='timep(this.id);'
      ...
      <div class=" form-group m-none dis-inline vertical-align-middle pr-md">
        <span class="">
          <select id="startDateWeekly"
                  ...
                  name="dayOfTheWeek" required oninvalid="this.setCustomValidity('Please fill out this field')">
            <option value=''>Select</option>
            <option
        ...
        <div class="dis_inlinetop p-none">
          ...
          <span class="form-group m-none dis-inline vertical-align-middle pr-md">
            <input id="selectWeeklyTimeAnchor" type="text"
                   class="form-control mt-sm clock ${(activeTaskBo.isDuplicate > 0)?'cursor-none' : ''}"
                   required oninvalid="this.setCustomValidity('Please fill out this field')" onclick="timep(this.id)" placeholder="Time"
                   name="activeTaskFrequenciesBo.frequencyTime"
                   value="${activeTaskBo.activeTaskFrequenciesBo.frequencyTime}"/>
            <span class='help-block with-errors red-txt'></span>
          </span>
        ...
        <div class="dis_inlinetop">
          <span class="form-group m-none dis-inline vertical-align-middle pr-md">
            ...
            <input id="weeksAnchor" type="text"
                   ...
                   value="${activeTaskBo.repeatActiveTask}" required oninvalid="this.setCustomValidity('Please fill out this field')"
                   onkeypress="return isNumber(event, this)"
                   pattern="^(0{0,2}[1-9]|0?[1-9][0-9]|[1-9][0-9][0-9])$"
                   data-pattern-error="Please enter valid number." maxlength="3"/>
            <span class='help-block with-errors red-txt'></span>
      ...
      <div class="monthlyStartCls  col-md-3 pl-none">
        <span class="form-group m-none dis-inline vertical-align-middle pr-md">
          ...
          <input id="pickStartDate" type="text"
                 class="form-control mt-sm calendar ${(activeTaskBo.isDuplicate > 0)?'cursor-none' : ''}"
                 placeholder="Choose start date" required oninvalid="this.setCustomValidity('Please fill out this field')" name="activeTaskLifetimeStart"
                 value="${activeTaskBo.activeTaskLifetimeStart}" readonly="readonly"/>
          <span class='help-block with-errors red-txt'></span>
        </span>
      </div>
        ...
        <div class="manually-option mb-md form-group" id="0">
          ...
          <span class="form-group dis-inline vertical-align-middle pr-md">
            <input id="StartDate0" type="text" count='0'
                   ...
                   onclick='customStartDate(this.id,0);' required oninvalid="this.setCustomValidity('Please fill out this field')"/>
            <span class='help-block with-errors red-txt'></span>
          </span>
          ...
          <span class="form-group dis-inline vertical-align-middle pr-md">
            <input id="EndDate0" type="text" count='0'
                   ...
                   onclick='customEndDate(this.id,0);' required oninvalid="this.setCustomValidity('Please fill out this field')"/>
            <span class='help-block with-errors red-txt'></span>
            </span>            
          ...
          <span class="form-group dis-inline vertical-align-middle pr-md">
            <input id="customTime0" type="text" count='0' class="form-control clock cusTime"
                   ...
                   disabled required oninvalid="this.setCustomValidity('Please fill out this field')"/>
            <span class='help-block with-errors red-txt'></span>
          </span>
          ...
          <div class="manually-option mb-md form-group" id="RegDate${customVar.index}">
            ...
            <span class="form-group  dis-inline vertical-align-middle pr-md">
              <input id="StartDate${customVar.index}" type="text" count='${customVar.index}'
                     ...
                     onclick='customStartDate(this.id,${customVar.index});' required oninvalid="this.setCustomValidity('Please fill out this field')"/>
              <span class='help-block with-errors red-txt'></span>
            </span>
            <span class="gray-xs-f mb-sm pr-md align-span-center">
              to
            ...
            <span class="form-group  dis-inline vertical-align-middle pr-md">
              <input id="EndDate${customVar.index}" type="text" count='${customVar.index}'
                     ...
                     onclick='customEndDate(this.id,${customVar.index});' required oninvalid="this.setCustomValidity('Please fill out this field')"/>
              <span class='help-block with-errors red-txt'></span>
            </span>
            <span class="form-group  dis-inline vertical-align-middle pr-md">
        ...
        <div class="manually-anchor-option mb-md form-group" id="0">
          ...
          <span class="form-group m-none dis-inline vertical-align-middle">
            <input id="xdays0" type="text"
                   ...
                   maxlength="3" required oninvalid="this.setCustomValidity('Please fill out this field')" pattern="[0-9]+"
                   data-pattern-error="Please enter valid number."/>
            <span
          ...
          <span class="form-group m-none dis-inline vertical-align-middle">
            <input id="ydays0" type="text"
                   ...
                   maxlength="3" pattern="[0-9]+"
                   data-pattern-error="Please enter valid number." required oninvalid="this.setCustomValidity('Please fill out this field')"/>
            <span
                class="help-block with-errors red-txt"></span>
          </span>
          <span class="mb-sm pr-md">
          ...
          <span class="form-group  dis-inline vertical-align-middle pr-md"
                style="margin-bottom: -13px"><input id="manualTime0"
                                                    ...
                                                    placeholder="Time" required oninvalid="this.setCustomValidity('Please fill out this field')"/>
            <span
                class='help-block with-errors red-txt'></span>
          </span>
