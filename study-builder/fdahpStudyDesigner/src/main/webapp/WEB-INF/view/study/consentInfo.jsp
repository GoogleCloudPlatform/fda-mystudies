    ...
    <div class="right-content-body">
      ...
      <div class="mt-sm form-group">
        <span class="radio radio-info radio-inline p-45"><input
            ...
            name="consentItemType" required  data-error="Please fill out this field" data-error="Please choose type"
        ...
        <span class="radio radio-inline p-45"><input type="radio"
                                                     ...
                                                     name="consentItemType" required  data-error="Please fill out this field"
      ...
      <div id="titleContainer">
        ...
        <div class="col-md-5 p-none form-group elaborateClass consentTitle">
          <select class="selectpicker" id="consentItemTitleId"
                  name="consentItemTitleId" required  data-error="Please fill out this field"
      ...
      <div>
        ...
        <div class="form-group visualStepDiv">
          <span class="radio radio-info radio-inline p-45"><input
              ...
              name="visualStep" required  data-error="Please fill out this field"
