...
public class StudyExportImportService {
  ...
  public String saveFileToCloudStorage(StudyBo studyBo, List<String> insertSqlStatements) {
    logger.info("saveFileToCloudStorage()  Starts");
    ...
    try {
      ...
      // stores the content to the path absoluteFileName in a bucket
      ...
      // get the signed URL of the SQL file
      String signedUrl =
          FdahpStudyDesignerUtil.getSignedUrlForExportedStudy(
              absoluteFileName, Integer.parseInt(map.get("signed.url.duration.in.hours")));

      // updates the signed URL to the DB
      String message =
