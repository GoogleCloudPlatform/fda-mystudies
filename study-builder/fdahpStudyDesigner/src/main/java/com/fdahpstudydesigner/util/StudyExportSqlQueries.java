...
public class StudyExportSqlQueries {
  ...
  public static final String ACTIVETASK_FREQUENCIES =
      "INSERT INTO `active_task_frequencies` (`id`, `active_task_id`, `frequency_date`, `frequency_time`, `is_launch_study`, `is_study_life_time`, `time_period_from_days`, `time_period_to_days`, `x_days_sign`, `y_days_sign`, `sequence_number`) VALUES (<id>, <active_task_id>, <frequency_date>, <frequency_time>, <is_launch_study>, <is_study_life_time>, <time_period_from_days>, <time_period_to_days>, <x_days_sign>, <y_days_sign>, <sequence_number>);";
  ...
  public static final String COMPREHENSION_TEST_RESPONSE =
      "INSERT INTO `comprehension_test_response` (`id`, `comprehension_test_question_id`, `correct_answer`, `response_option`, `sequence_number`) VALUES (<id>, <comprehension_test_question_id>, <correct_answer>, <response_option>, <sequence_number>);";

  public static final String CONSENT =
      "INSERT INTO `consent` (`id`, `allow_without_permission`, `comprehension_test_minimum_score`, `consent_doc_content`, `consent_doc_type`, `created_by`, `created_on`, `custom_study_id`, `e_consent_agree`, `e_consent_datetime`, `e_consent_firstname`, `e_consent_lastname`, `e_consent_signature`, `html_consent`, `learn_more_text`, `is_live`, `long_description`, `modified_by`, `modified_on`, `need_comprehension_test`, `share_data_permissions`, `short_description`, `study_id`, `tagline_description`, `title`, `version`) VALUES (<id>, <allow_without_permission>, <comprehension_test_minimum_score>, <consent_doc_content>, <consent_doc_type>, <created_by>, <created_on>, <custom_study_id>, <e_consent_agree>, <e_consent_datetime>, <e_consent_firstname>, <e_consent_lastname>, <e_consent_signature>, <html_consent>, <learn_more_text>, <is_live>, <long_description>, <modified_by>, <modified_on>, <need_comprehension_test>, <share_data_permissions>, <short_description>, <study_id>, <tagline_description>, <title>, <version>);";
  ...
  public static final String QUESTIONNAIRES =
      "INSERT INTO `questionnaires` (`id`, `active`, `anchor_date_id`, `branching`, `created_by`, `created_date`, `custom_study_id`, `day_of_the_week`, `frequency`, `is_Change`, `is_live`, `modified_by`, `modified_date`, `repeat_questionnaire`, `schedule_type`, `short_title`, `status`, `study_id`, `study_lifetime_end`, `study_lifetime_start`, `title`, `version`, `sequence_number`) VALUES (<id>, <active>, <anchor_date_id>, <branching>, <created_by>, <created_date>, <custom_study_id>, <day_of_the_week>, <frequency>, <is_Change>, <is_live>, <modified_by>, <modified_date>, <repeat_questionnaire>, <schedule_type>, <short_title>, <status>, <study_id>, <study_lifetime_end>, <study_lifetime_start>, <title>, <version>, <sequence_number>);";

  public static final String QUESTIONNAIRES_CUSTOM_FREQUENCIES =
      "INSERT INTO `questionnaires_custom_frequencies` (`id`, `frequency_end_date`, `frequency_start_date`, `questionnaires_id`, `time_period_from_days`, `time_period_to_days`, `is_used`, `x_days_sign`, `y_days_sign`, `frequency_end_time`, `frequency_start_time`, `sequence_number`) VALUES (<id>, <frequency_end_date>, <frequency_start_date>,  <questionnaires_id>, <time_period_from_days>, <time_period_to_days>, <is_used>, <x_days_sign>, <y_days_sign>, <frequency_end_time>, <frequency_start_time>, <sequence_number> );";

  public static final String QUESTIONNAIRES_FREQUENCIES =
      "INSERT INTO `questionnaires_frequencies` (`id`, `frequency_date`, `frequency_time`, `is_launch_study`, `is_study_life_time`, `questionnaires_id`, `time_period_from_days`, `time_period_to_days`, `x_days_sign`, `y_days_sign`, `sequence_number`) VALUES (<id>, <frequency_date>, <frequency_time>, <is_launch_study>, <is_study_life_time>, <questionnaires_id>, <time_period_from_days>, <time_period_to_days>, <x_days_sign>, <y_days_sign>, <sequence_number> );";
  ...
  public static final String STUDIES =
      "INSERT INTO `studies` (`id`, `app_id`, `category`, `created_by`, `created_on`, `custom_study_id`, `description`, `enrolling_participants`,  `full_name`, `has_activitetask_draft`, `has_activity_draft`, `has_consent_draft`, `has_questionnaire_draft`, `has_study_draft`, `inbox_email_address`, `irb_review`, `is_live`, `media_link`, `modified_by`, `modified_on`, `name`, `platform`, `research_sponsor`, `sequence_number`, `status`, `study_pre_active_flag`, `study_tagline`, `study_website`, `study_lunched_date`, `tentative_duration`, `tentative_duration_weekmonth`, `thumbnail_image`, `type`, `version`, `enrollmentdate_as_anchordate`,  `destination_custom_study_id`, `export_signed_url`) VALUES (<id>, <app_id>, <category>, <created_by>, <created_on>, <custom_study_id>, <description>, <enrolling_participants>, <full_name>, <has_activitetask_draft>, <has_activity_draft>, <has_consent_draft>, <has_questionnaire_draft>, <has_study_draft>, <inbox_email_address>, <irb_review>, <is_live>, <media_link>, <modified_by>, <modified_on>, <name>, <platform>, <research_sponsor>, <sequence_number>, <status>, <study_pre_active_flag>, <study_tagline>, <study_website>, <study_lunched_date>, <tentative_duration>, <tentative_duration_weekmonth>, <thumbnail_image>, <type>, <version>, <enrollmentdate_as_anchordate>, <destination_custom_study_id>, <export_signed_url>);";

  public static final String STUDY_PAGE =
      "INSERT INTO `study_page` (`page_id`, `created_by`, `created_on`, `description`, `image_path`, `modified_by`, `modified_on`, `study_id`, `title`, `sequence_number`) VALUES (<page_id>, <created_by>, <created_on>, <description>, <image_path>, <modified_by>, <modified_on>, <study_id>, <title>, <sequence_number>);";
