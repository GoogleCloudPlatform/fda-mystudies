...
public class StudyExportSqlQueries {
  ...
  public static final String STUDIES =
      "INSERT INTO `studies` (`id`, `app_id`, `category`, `created_by`, `created_on`, `custom_study_id`, `description`, `enrolling_participants`,  `full_name`, `has_activitetask_draft`, `has_activity_draft`, `has_consent_draft`, `has_questionnaire_draft`, `has_study_draft`, `inbox_email_address`, `irb_review`, `is_live`, `media_link`, `modified_by`, `modified_on`, `name`, `platform`, `research_sponsor`, `sequence_number`, `status`, `study_pre_active_flag`, `study_tagline`, `study_website`, `study_lunched_date`, `tentative_duration`, `tentative_duration_weekmonth`, `thumbnail_image`, `type`, `version`, `enrollmentdate_as_anchordate`, `file_path`, `destination_custom_study_id`) VALUES (<id>, <app_id>, <category>, <created_by>, <created_on>, <custom_study_id>, <description>, <enrolling_participants>, <full_name>, <has_activitetask_draft>, <has_activity_draft>, <has_consent_draft>, <has_questionnaire_draft>, <has_study_draft>, <inbox_email_address>, <irb_review>, <is_live>, <media_link>, <modified_by>, <modified_on>, <name>, <platform>, <research_sponsor>, <sequence_number>, <status>, <study_pre_active_flag>, <study_tagline>, <study_website>, <study_lunched_date>, <tentative_duration>, <tentative_duration_weekmonth>, <thumbnail_image>, <type>, <version>, <enrollmentdate_as_anchordate>, <file_path>, <destination_custom_study_id>);";
