...
public enum AuthScimEvent implements AuditLogEvent {
  SIGNIN_SUCCEEDED(null, SCIM_AUTH_SERVER, PARTICIPANT_USER_DATASTORE, null, "SIGNIN_SUCCEEDED"),

  SIGNIN_FAILED(null, SCIM_AUTH_SERVER, PARTICIPANT_USER_DATASTORE, null, "SIGNIN_FAILED"),

  SIGNIN_FAILED_UNREGISTERED_USER(
      null, SCIM_AUTH_SERVER, PARTICIPANT_USER_DATASTORE, null, "SIGNIN_FAILED_UNREGISTERED_USER"),

  SIGNIN_FAILED_INVALID_PASSWORD(
      null, SCIM_AUTH_SERVER, PARTICIPANT_USER_DATASTORE, null, "SIGNIN_FAILED_INVALID_PASSWORD"),

  SIGNIN_FAILED_EXPIRED_PASSWORD(
      null, SCIM_AUTH_SERVER, PARTICIPANT_USER_DATASTORE, null, "SIGNIN_FAILED_EXPIRED_PASSWORD"),

  PASSWORD_HELP_REQUESTED(
      null, SCIM_AUTH_SERVER, PARTICIPANT_USER_DATASTORE, null, "PASSWORD_HELP_REQUESTED"),
  ...
  PASSWORD_HELP_EMAIL_SENT(
      null, SCIM_AUTH_SERVER, PARTICIPANT_USER_DATASTORE, null, "PASSWORD_HELP_EMAIL_SENT"),

  PASSWORD_HELP_EMAIL_FAILED(
      null, SCIM_AUTH_SERVER, PARTICIPANT_USER_DATASTORE, null, "PASSWORD_HELP_EMAIL_FAILED"),
  ...
  PASSWORD_RESET_SUCCEEDED(
      null, SCIM_AUTH_SERVER, PARTICIPANT_USER_DATASTORE, null, "PASSWORD_RESET_SUCCEEDED"),

  PASSWORD_RESET_FAILED(
      null, SCIM_AUTH_SERVER, PARTICIPANT_USER_DATASTORE, null, "PASSWORD_RESET_FAILED"),
  ...
  PASSWORD_CHANGE_SUCCEEDED(
      null, SCIM_AUTH_SERVER, PARTICIPANT_USER_DATASTORE, null, "PASSWORD_CHANGE_SUCCEEDED"),

  PASSWORD_CHANGE_FAILED(
      null, SCIM_AUTH_SERVER, PARTICIPANT_USER_DATASTORE, null, "PASSWORD_CHANGE_FAILED"),

  USER_SIGNOUT_SUCCEEDED(
      null, SCIM_AUTH_SERVER, PARTICIPANT_USER_DATASTORE, null, "USER_SIGNOUT_SUCCEEDED"),

  USER_SIGNOUT_FAILED(
      null, SCIM_AUTH_SERVER, PARTICIPANT_USER_DATASTORE, null, "USER_SIGNOUT_FAILED"),
